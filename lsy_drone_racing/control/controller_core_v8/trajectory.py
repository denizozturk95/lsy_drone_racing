"""Global reference planning with gate-post funnels for controller_v8.
...
from common_controller_v2.avoidance; the spline timing/repair is v8's own controller_core_v8.timing.
"""
