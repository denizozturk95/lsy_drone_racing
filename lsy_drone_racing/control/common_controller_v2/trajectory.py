"""Generic, observation-driven reference planning for controller_v6.
...
from lsy_drone_racing.control.common_controller_v2.timing import repair_obstacles

if TYPE_CHECKING:
    from numpy.typing import NDArray

    from lsy_drone_racing.control.common_controller_v2.settings import PlannerSettings
