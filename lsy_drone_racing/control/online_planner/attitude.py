...
from lsy_drone_racing.control.online_planner.geometry import body_z_from_quat
from lsy_drone_racing.control.online_planner.settings import CommandSettings
from lsy_drone_racing.control.online_planner.trajectory import ReferenceCurve
...
def attitude_action(
    ...
    """track a position reference and return roll pitch yaw and collective thrust."""
